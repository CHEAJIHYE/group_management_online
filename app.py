...
INSIGHT_CATEGORIES = {
    "경제": [
        "가격을 9,900원처럼 9로 끝나게 표기하면 실제 차이보다 훨씬 싸게 느껴지는 '왼쪽 자리 효과'가 있습니다.",
        "'한정 수량'이라는 문구만으로도 구매 결정 속도가 평균 30% 가까이 빨라진다는 연구가 있습니다.",
        "같은 제품이라도 '3개 중 2개 남음'처럼 희소성을 보여주면 구매 전환율이 뚜렷하게 올라간다고 합니다.",
        "세계 최초의 지폐는 7세기 중국 당나라에서 등장했습니다.",
        "스타벅스 사이렌 로고 속 인어는 원래 두 개의 꼬리를 가지고 있습니다.",
        "세계에서 가장 비싼 우표 한 장이 자동차 여러 대 가격에 맞먹는 값에 거래된 적이 있습니다.",
        "애플은 한때 파산 직전까지 갔다가, 아이맥 하나로 기사회생했습니다.",
        "'블랙 프라이데이'라는 이름은 매출 장부가 적자에서 흑자로 바뀐다는 뜻에서 유래했습니다.",
    ],
    "심리": [
        "사람의 첫인상은 만난 지 단 0.1초 만에 형성된다는 연구가 있습니다.",
        "사람은 이득을 얻는 기쁨보다 손실을 피하려는 마음이 약 2배 더 강하다고 합니다 (손실 회피 편향).",
        "답이 너무 많으면 오히려 선택을 미루게 되는 '선택의 역설' 현상이 있습니다.",
        "빨간색은 식욕을 자극하고 파란색은 억제한다는 색채심리 연구가 있어, 음식점 인테리어에 빨간색이 많습니다.",
        "사람은 자신이 한 말을 지키려는 경향이 강해, 작은 약속을 먼저 받아내는 설득 기법이 효과적입니다.",
        "웃는 표정을 지으면 실제로 기분이 좋아지는 효과가 있다는 연구 결과가 있습니다.",
        "낯선 사람도 이름을 불러주면 훨씬 호감을 느낀다는 연구가 있습니다.",
        "침묵을 어색해하는 심리 때문에, 협상에서는 먼저 말을 꺼내는 쪽이 불리해지는 경우가 많습니다.",
    ],
    "사회": [
        "전 세계에서 커피를 가장 많이 마시는 나라는 핀란드입니다.",
        "세계 인구의 절반 이상이 이제 도시에 거주하고 있습니다.",
        "한국은 세계에서 인터넷 속도가 가장 빠른 나라 중 하나로 꾸준히 꼽힙니다.",
        "일본에는 '고독사'를 막기 위해 정기적으로 안부를 확인해주는 우유 배달 서비스가 있습니다.",
        "세계에서 가장 인구가 많은 도시권은 일본 도쿄권입니다.",
        "결혼식 축의금 문화는 나라마다 크게 달라, 현금 대신 실용적인 선물을 주고받는 나라도 많습니다.",
        "전 세계 언어는 약 7,000개가 있지만, 그중 절반은 100년 안에 사라질 위기라고 합니다.",
        "명함을 주고받는 문화는 원래 중국 관료 사회에서 시작됐다고 알려져 있습니다.",
    ],
    "스포츠": [
        "축구 경기의 정식 시간(90분)은 19세기 영국 클럽 두 곳이 합의한 데서 유래했습니다.",
        "마라톤 거리(42.195km)는 1908년 런던 올림픽에서 왕실 관람석까지 맞추다 정해졌습니다.",
        "야구공의 실밥은 정확히 108땀으로 꿰매져 있습니다.",
        "올림픽 오륜기의 다섯 색깔은 전 세계 모든 나라 국기에 최소 하나는 포함된다고 알려져 있습니다.",
        "농구는 원래 축구공이 아니라 복숭아 바구니를 골대로 써서 시작된 스포츠입니다.",
        "태권도는 1988년 서울 올림픽에서 처음 시범 종목으로 채택됐습니다.",
        "테니스의 공식 서브 속도 기록은 시속 260km를 넘습니다.",
        "골프에서 '버디'라는 용어는 '멋지다'는 뜻의 미국 속어에서 유래했습니다.",
    ],
    "과학": [
        "문어는 심장이 3개이고, 피는 파란색입니다.",
        "지구 나이는 약 45억 년으로, 인류 역사(약 20만 년)는 그중 0.004%에 불과합니다.",
        "인간의 뇌는 몸무게의 2%뿐이지만 하루 에너지의 20%를 씁니다.",
        "물이 얼음이 되면 부피가 약 9% 늘어납니다.",
        "북극곰의 털은 사실 하얀색이 아니라 투명합니다. 빛의 산란 때문에 하얗게 보이는 것뿐입니다.",
        "타조는 눈이 뇌보다 더 큽니다.",
        "꿈을 꾸는 동안 몸은 일시적으로 마비 상태가 되어 실제로 움직이지 못한다고 합니다.",
        "달은 지구에서 매년 약 3.8cm씩 멀어지고 있습니다.",
    ],
    "역사": [
        "고대 세계 7대 불가사의 중 지금까지 남아있는 건 이집트 기자의 피라미드 하나뿐입니다.",
        "꿀은 부패하지 않아서, 3000년 된 이집트 무덤에서 발견된 꿀도 먹을 수 있는 상태였습니다.",
        "로마 제국은 한때 지금의 3개 대륙에 걸쳐 있었습니다.",
        "세계 최초의 우편번호 제도는 1941년 독일에서 시작됐습니다.",
        "'커피'라는 단어는 에티오피아의 지역 이름 '카파'에서 유래했다는 설이 있습니다.",
        "만리장성이 우주에서 육안으로 보이지 않는다는 사실이 여러 우주비행사에 의해 확인됐습니다.",
        "최초의 컴퓨터 마우스는 나무로 만들어졌습니다.",
        "세계 최초의 신호등은 1868년 런던에서 가스등으로 만들어졌습니다.",
    ],
    "테크": [
        "최초의 이메일은 1971년에 전송되었습니다.",
        "최초의 컴퓨터 바이러스는 1980년대 초, 장난으로 만들어졌습니다.",
        "QR코드는 원래 자동차 부품 재고 관리를 위해 일본에서 개발되었습니다.",
        "세계 최초의 도메인 이름은 1985년에 등록된 symbolics.com입니다.",
        "와이파이(WiFi)라는 이름은 별다른 약자가 아니라 브랜딩을 위해 만들어진 이름입니다.",
        "최초의 스마트폰은 1992년 IBM이 만든 '사이먼'이라는 제품이었습니다.",
        "유튜브에 처음 올라온 영상은 창업자가 동물원에서 찍은 19초짜리 영상이었습니다.",
        "최초의 컴퓨터 프로그래머는 19세기 여성 수학자 에이다 러브레이스였습니다.",
    ],
    "건강": [
        "사람의 심장은 평생 동안 약 25억 번 뛴다고 알려져 있습니다.",
        "사람의 후각은 1조 가지 냄새를 구분할 수 있다는 연구 결과가 있습니다.",
        "웃음은 스트레스 호르몬을 낮추고 면역력을 높이는 데 도움이 된다고 알려져 있습니다.",
        "짧은 낮잠(10~20분)은 오후 집중력을 눈에 띄게 회복시켜준다는 연구가 있습니다.",
        "사람은 나이가 들수록 미각보다 후각의 영향을 더 크게 받는다고 합니다.",
        "규칙적인 걷기만으로도 심혈관 건강에 유의미한 효과가 있다는 연구가 많습니다.",
        "사람의 뼈는 태어날 때 약 300개였다가, 성장하며 서로 붙어 성인이 되면 206개가 됩니다.",
        "바나나는 식물학적으로 '베리류'에 속하지만, 딸기는 베리가 아닙니다.",
    ],
}


def fetch_wikipedia_random_fact():
    """한국어 위키백과 공식 API로 무작위 문서 요약을 가져옵니다.
    (위키백과가 직접 운영하는 정식 공개 API라, 날씨/증시 때 썼던 비공식 주소보다
    훨씬 안정적입니다.) 내용이 너무 짧은 문서(스텁)는 건너뛰고 최대 5회 재시도합니다."""
    for _ in range(5):
        try:
            resp = requests.get(
            ...
            if not title or len(extract) < 40:
                continue
            sentence = extract.split(". ")[0].split(".\n")[0]
            if len(sentence) > 160:
                sentence = sentence[:160].rstrip() + "…"
            elif not sentence.endswith(("다", "요", "음", ".", "!", "?")):
                sentence += "."
...
def get_dynamic_insight():
    """위키백과 무작위 문서에서 매번 새로운 인사이트를 가져오고, 네트워크 문제로
    실패하면 내장된 문구 목록에서 대신 하나를 보여줍니다 (항상 뭔가는 표시됨)."""
    wiki_result = fetch_wikipedia_random_fact()
    if wiki_result:
        return wiki_result
    all_items = [(cat, fact) for cat, facts in INSIGHT_CATEGORIES.items() for fact in facts]
...
with st.sidebar:
    if "_current_insight" not in st.session_state:
        st.session_state["_current_insight"] = get_dynamic_insight()
    _insight_title, _insight_text = st.session_state["_current_insight"]
    st.info(f"💡 오늘의 인사이트 · {_insight_title}\n\n{_insight_text}")
    ...
    def render_one(c, indent=0):
        ...
        with text_col:
            if editing:
                ...
                time_display = f"✏️ 수정됨 ({c['edited_at']})" if c.get("edited_at") else c["time"]
                st.markdown(
                    f"{prefix}**{c['author']}** ({time_display}): {c['text']}",
                    unsafe_allow_html=True,
                )
        with btn_group:
...
# --------------------------------------------------------------------------
    ...
    for p in shown:
        ...
        with st.container(border=True):
            ...
            _time_display = f"✏️ 수정됨 ({p['edited_at']})" if p.get("edited_at") else p["created_at"]
            st.caption(f"작성자 {p['author']} · {_time_display}")
