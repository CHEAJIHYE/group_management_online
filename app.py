...
INSIGHT_CATEGORIES = {
    "경제용어": [
        "'기회비용'이란 하나를 선택함으로써 포기하게 되는 다른 선택의 가치를 뜻합니다.",
        "'매몰비용'은 이미 지불해서 회수할 수 없는 비용으로, 합리적 판단에서는 고려하지 않아야 한다고 여겨집니다.",
        "'왼쪽 자리 효과'는 가격을 9,900원처럼 9로 끝내면 실제 차이보다 훨씬 싸게 느껴지는 현상을 말합니다.",
        "'희소성의 원칙'은 사람들이 얻기 어려운 것일수록 더 가치 있게 여긴다는 개념입니다.",
        "'스태그플레이션'은 경기 침체와 물가 상승이 동시에 일어나는 드문 경제 현상을 말합니다.",
        "'블랙 프라이데이'라는 이름은 매출 장부가 적자에서 흑자로 바뀐다는 뜻에서 유래했습니다.",
        "'립스틱 효과'는 불황기에 저가의 사치품 소비가 오히려 늘어나는 현상을 말합니다.",
        "'캐즘'은 신기술이 초기 수용자에서 대중 시장으로 넘어가지 못하고 정체되는 구간을 뜻합니다.",
    ],
    "심리": [
    ...
    "문화": [
        "K-POP이라는 용어는 2000년대 이후 해외에서 한국 대중음악을 부르며 정착된 이름입니다.",
        "세계 최초의 영화관은 1895년 프랑스 파리에서 문을 열었습니다.",
        "'한류'라는 단어는 1990년대 후반 중국 언론에서 한국 문화 열풍을 부르며 처음 쓰였습니다.",
        "세계에서 가장 많이 번역된 책은 성경이며, 그다음은 피노키오라고 알려져 있습니다.",
        "일본 애니메이션을 뜻하는 '아니메'는 영어 '애니메이션'을 일본식으로 줄인 말입니다.",
        "칸 영화제의 황금종려상 트로피는 매년 실제 종려나무 잎을 본떠 새로 제작됩니다.",
        "세계 3대 영화제는 칸·베니스·베를린 영화제로 꼽힙니다.",
        "비틀즈의 앨범 '애비 로드' 표지 사진은 단 10분 만에 촬영되었습니다.",
    ],
    "역사": [
    ...
    "트렌드": [
        "'바이럴'이라는 표현은 콘텐츠가 마치 바이러스처럼 빠르게 퍼진다는 뜻에서 유래했습니다.",
        "짧은 영상(숏폼) 콘텐츠는 평균 시청 지속 시간이 긴 영상보다 훨씬 높다는 조사가 많습니다.",
        "챌린지 콘텐츠는 참여 장벽이 낮을수록 확산 속도가 훨씬 빠르다는 특징이 있습니다.",
        "특정 유행어나 챌린지는 평균 몇 주 안에 정점을 찍고 빠르게 사그라드는 패턴을 보입니다.",
        "인플루언서 마케팅은 팔로워 수보다 '참여율'이 실제 구매 전환에 더 큰 영향을 준다고 알려져 있습니다.",
        "세대별로 선호하는 플랫폼이 다르기 때문에, 같은 트렌드도 채널마다 확산 속도가 다르게 나타납니다.",
        "과거 유행이 주기적으로 다시 돌아오는 현상을 '뉴트로'라고 부르기도 합니다.",
        "한정판이나 콜라보 상품은 출시 직후 재판매 시장에서 웃돈이 붙는 경우가 많습니다.",
    ],
    "밈": [
        "'밈(meme)'이라는 단어는 1976년 리처드 도킨스가 문화의 전달 단위를 설명하며 만든 말입니다.",
        "최초로 널리 퍼진 인터넷 밈 중 하나는 1990년대 말의 '댄싱 베이비' 애니메이션으로 꼽힙니다.",
        "밈은 보통 며칠에서 몇 주 사이에 폭발적으로 퍼졌다가 빠르게 소멸하는 짧은 생명 주기를 가집니다.",
        "특정 표정이나 짤방이 밈으로 자리 잡으면, 원본 맥락과 전혀 다른 의미로 쓰이는 경우가 많습니다.",
        "밈은 언어 장벽을 넘어 확산되는 경우가 많아, 국제적인 유행으로 이어지기도 합니다.",
        "기업들도 마케팅에 밈을 활용하지만, 유행 주기가 짧아 타이밍을 놓치면 오히려 어색해 보일 수 있습니다.",
        "'짤방'이라는 한국어 표현은 원래 '짤림 방지'의 줄임말에서 유래했다고 알려져 있습니다.",
        "밈은 반복과 변형을 거듭하며 퍼지는 특징이 있어, 같은 밈이라도 버전마다 조금씩 다르게 변형됩니다.",
    ],
}

# 카테고리 라벨 -> 실제 한국어 위키백과 분류(카테고리) 페이지 이름 후보들.
# '트렌드'/'밈'은 위키백과에 정식으로 대응되는 분류가 마땅치 않아, 실패 시
# 위의 큐레이션 문구로 대체되는 비중이 다른 카테고리보다 높을 수 있습니다.
WIKI_CATEGORY_MAP = {
    "경제용어": ["분류:경제학 용어", "분류:경제"],
    "심리": ["분류:심리학"],
    "과학": ["분류:과학"],
    "문화": ["분류:문화"],
    "역사": ["분류:역사"],
...
def _extract_summary_sentence(extract):
            ...
            for m in members[:20]:
                ...
                try:
                    ...
                    if summary_resp.status_code != 200:
                        continue
                    extract = (summary_resp.json().get("extract") or "").strip()
                    if len(extract) < 40:
                        continue
                    return title, _extract_summary_sentence(extract)
                except Exception:
                    continue
        except Exception:
            continue
...
def get_dynamic_insight():
    """지정된 카테고리(경제용어/심리/과학/문화/역사/트렌드/밈) 중 하나를 무작위로 골라,
